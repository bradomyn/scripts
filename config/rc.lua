...
--   { "edit config", "terminator -x vim /home/bradomyn/.config/awesome/rc.lua"},
   ...
   { "suspend-hybrid", "sudo pm-suspend-hybrid"},
...
--        { "file manager", "nautilus --no-desktop --browser" },
     ...
     -- { "virtual", "/home/gio/script/virtual" },
        { "firefox", "firefox" },
        { "chromium", "chromium --memory-model=low" },
...
-------------------------------------------------------------------------
    ...
    awful.key({modkey,            }, "b",      function () awful.util.spawn("chromium --memory-model=low") end),
